...
const AboutUs: React.FunctionComponent = React.forwardRef<HTMLDivElement>(
  (props, ref) => {
    return (
      <section ref={ref} className="bg-white text-black px-40">
        <div className="flex items-center justify-between">
          ...
          <div className="w-1/2 relative py-24">
            <div className="absolute left-0 bottom-0 top-0 animate-mil-lines">
              <svg
                width="250"
